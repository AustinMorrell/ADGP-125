...
namespace RPG
{
    ...
    class Game
    {
        ...
        private Player M1 = new Player("Cloud", 100, 20, 5, "", Environment.CurrentDirectory + @"\Images\Cloud.gif", 1, 2, 3);
        private Player M2 = new Player("Shadow", 100, 20, 5, "", Environment.CurrentDirectory + @"\Images\Shadow.gif", 1, 4, 3);
        private Player M3 = new Player("Sora", 100, 20, 5, "", Environment.CurrentDirectory + @"\Images\Sora.gif", 1, 3, 5);
